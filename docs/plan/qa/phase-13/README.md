...
|---|---|---|---|
| unit | 14/14 | `unit/TEST-app.tileshell.ui.fluent.{FluentMaterialTest,StaticBackdropTest}.xml` (kept here; a7ef430b) | FluentMaterialTest 11/11 (derivation, the rule on all 8 combinations, noise); StaticBackdropTest 3/3 (a cancelled build is not a failure: red on the old handling, gate review A-B1) |
| E1 | PASS 24/0 (+1 recorded) | `E1/E1.txt`, `E1/slice-*.txt` | apk 509f6e49; step slices for E12. Earlier: `E1-run1-c2ac10ea/`, `E1-run2-stopped-120e52ec/`, `E1-run3-db078d6a/` (24/0) |
| E2 | PASS 22/0 (+2 recorded) | `E2/E2.txt`, `E2/profile-*.txt` | apk 509f6e49. Earlier: `E2-run1-c2ac10ea/`, `E2-run2-db078d6a/` (22/0) |
...
| E4 | PASS 48/0 | `E4/E4.txt` | apk 509f6e49. Earlier: `E4-run1-nodiscriminator/`, `E4-run2-15aa7f5f/`, `E4-run3-db078d6a/` (48/0) |
...
| E8 | PASS 32/0 (+8 recorded) | `E8/E8.txt`, `E8/motion-lines.txt` | apk 509f6e49; shell clock: pane, reminder menu, pivot, band within their bounds, maxGapMs <= 33.4; corroboration retaken under phase 05's rule inside each surface's bounds: pane attempt 1 (17.1 ms, window 233 vs settle 246), reminder menu attempt 3 (17.0 ms, 233 vs 243), pivot attempt 2 (18.0 ms, 500 >= 263), band a one-frame jump. Earlier: `E8-run1-120e52ec/` (28/0, corroboration never retaken — gate review B-B2; its re-analysis `corroboration-rerun.txt`) |
...
| E10 | PASS 13/0 (+5 recorded) | `E10/E10.txt` | apk 509f6e49; Photos 6 -> 7 before A, C - B 9514 KB, A2 - A 1314 KB. Earlier: `E10-run1-layer-while-off-120e52ec/` (the product defect, fixed 3448c92f), `E10-run2-photos-face-db078d6a/` (12 675 KB), `E10-run3-settings-code-db078d6a/` (4412 KB), `E10-run4-db078d6a/` (13/0, vacuous Photos check); diagnosis `E10_DIAG/` |
...
| E12 | PASS 48/0 | `E12/E12.txt` | E1 E2 E4 on 509f6e49, E3 E5 on 15aa7f5f (asserts the c73c32cf..a7ef430b file list). Earlier: `E12-run1-db078d6a/` |
| E13 | PASS 10/0 | `E13/E13.txt` | apk 509f6e49. Earlier: `E13-run1-fullwidth-120e52ec/`, `E13-run2-db078d6a/` (10/0) |
...
| no_image | PASS | `EDGE_NO_IMAGE/` | apk 509f6e49, MARK before the restart. `EDGE_NO_IMAGE-run1-mark-late/` |
| light | PASS 8/0 | `EDGE_LIGHT/` | apk 509f6e49: tint (255,255,255) asserted, backdrop >= 200, text 0. `EDGE_LIGHT-run1-tint-recorded/` |
...
| rapid | PASS 5/0 | `EDGE_RAPID/` | apk 509f6e49: 10 holds, 10 band show lines, 8.8 s, PSS +1308 KB. `EDGE_RAPID-run1-no-show-assert/` = no proof a menu opened (gate review B-B1) |
