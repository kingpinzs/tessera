...
# Builds (INDEX Change Log 2026-09-26, the specific-tests ruling): E1, E2 and E4 ran on apk db078d6a (the build of
# 3448c92f); E3 and E5 on apk 15aa7f5f (the build of c73c32cf), counted because the diff between those two commits does
...
CUR=db078d6a; OLD=15aa7f5f; CUR_C=3448c92f; OLD_C=c73c32cf
...
assert_eq "the $OLD -> $CUR diff is L13-2's five files and StaticBackdrop.kt only (no pane or reminder-menu code)" \
  "app/src/main/kotlin/app/tileshell/applist/AppListMenu.kt app/src/main/kotlin/app/tileshell/applist/AppListPage.kt app/src/main/kotlin/app/tileshell/music/MusicCollectionPage.kt app/src/main/kotlin/app/tileshell/ui/components/ModalOverlay.kt app/src/main/kotlin/app/tileshell/ui/fluent/StaticBackdrop.kt app/src/test/kotlin/app/tileshell/ui/components/ModalOverlayTest.kt " \
  "$DIFF"
